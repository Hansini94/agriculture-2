...
Class Foreign extends CI_Controller {
    ...
    private $table_name = "tbl_abc_student_alumni";
    private $page_id = "18";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/our_experts/foreign_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/our_experts/foreign');
            } else {
