...
Class Consultancies extends CI_Controller {
    ...
    private $table_name = "tbl_abc_student_research";
    private $page_id = "21";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/training_consultancies/consultancies_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/training_consultancies/consultancies');
            } else {
