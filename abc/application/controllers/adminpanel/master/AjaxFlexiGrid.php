...
class AjaxFlexiGrid extends CI_Controller {
    ...
    function get_user_data() {
        ...
        $table_name = "tbl_abc_backend_user";
    ...
    function get_sector_list() {
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_company_sector";
    ...
    function get_areaofservice_list() {
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_company_type";
    ...
    function get_home_content_img() {
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_home_content";
    ...
    function get_generalaccount() {
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_frontend_user";
    ...
    function get_Reported_user_List() {
        $valid_fields = array('tbl_abc_report_user.id', 'tbl_abc_report_user.vCommentername', 'tbl_abc_report_user.vReason', 'tbl_abc_report_user.cEnable', 'tbl_abc_frontend_user.vName');
        $this->flexigrid->validate_post('tbl_abc_report_user.id', 'desc', $valid_fields);
    ...
    function get_main_facility_list() {
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_main_facilities";
    ...
    function get_sub_facility_list() {
        ...
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_sub_facilities";
    ...
    function room_property_list() {
        ...
        //List of all fields that can be sortable. This is Optional.
        //This prevents that a user sorts by a column that we dont want him to access, or that doesnt exist, preventing errors.
        $table_name = "tbl_abc_link_property_room_type";
