          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Completed Projects</b></li>
              </ol>
            </nav>
            </div>
          </div>
       ...
       <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row ms-auto">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-left: 0px !important;">
            ...
            <a href="<?php echo base_url('Projects'); ?>"><button class="nav-link " id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><p>Ongoing Projects</p></button></a>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><p>Completed Projects</p></button>
            </li>
          </ul>
