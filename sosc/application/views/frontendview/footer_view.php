      ...
      <div class="row">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 col-sm-12 footer_logo_col">
          ...
          <p style="color: #999999;" class="d-none d-lg-block">
            <small>Copyright ©<?php echo date("Y"); ?> Faculty of Agriculture - University of Peradeniya. <br> All Rights Reserved</small>
          </p>
        ...
        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12">
          ...
          <div class="row">
              ...
              <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 footer_link_col">
                ...
                <a href="<?php echo base_url("Module"); ?>"><p>Students</p></a>
                <a href="<?php echo base_url("Student-Alumni"); ?>"><p>Alumni</p></a>      
                <a href="<?php echo base_url("News"); ?>"><p>News</p></a>
                               
              </div>

              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 footer_link_col">
                <a href="<?php echo base_url("Undergraduate-Programme"); ?>"><p>Undergraduate Programme</p></a>
                <a href="<?php echo base_url("Postgraduate-Programme"); ?>"><p>Postgraduate Programme</p></a>
                <a href="<?php echo base_url("Research-Projects"); ?>"><p>Research Projects</p></a>
                <a href="<?php echo base_url("Student-Research"); ?>"><p>Student Research</p></a>   
                <a href="<?php echo base_url("Publications"); ?>"><p>Featured Publications</p></a>
              </div>
