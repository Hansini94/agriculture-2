<?php
if ($cSaveStatus == "E") {
    $id = $temperory_staff_data[0]->id;
    $vTitle = $temperory_staff_data[0]->vTitle;
    $tContent = $temperory_staff_data[0]->tContent;
    $cEnable = $temperory_staff_data[0]->cEnable;
} else {
    $id = '';
    $vTitle = '';
    $tContent = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_temperory_staff" name="edit_temperory_staff" action="<?php echo base_url('adminpanel/staff/temperory_staff/save_temperory_staff'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/staff/temperory_staff'); ?>';">Cancel</button>
