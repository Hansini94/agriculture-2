...
Class Profile extends CI_Controller {
    ...
    public function edit_profile($data = '') {
        ...
        $sql_user_type = "SELECT tbl_animal_user_type.vAccTypeName,tbl_animal_user_type.id FROM tbl_animal_user_type ORDER BY tbl_animal_user_type.vAccTypeName ASC";
