...
## contact us START
	public function get_contact_us_content() {
        ...
        $this->db->from('tbl_aeng_contact_us');
		//$this->db->order_by('tbl_aeng_currency.iOrder','asc');
        $query = $this->db->get();
...
##golden  key start	
	...
	public function get_main_slider_list() {
        ...
        $this->db->from('tbl_aeng_main_slider');
		$this->db->order_by('tbl_aeng_main_slider.iOrder','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
    ...
    public function get_edit_main_slider_video() {
        ...
        $this->db->from('tbl_aeng_main_slider_video');
		$this->db->where('id', 1);
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
    ...
    public function get_mobile_slider_list() {
        ...
        $this->db->from('tbl_aeng_mobile_slider');
		$this->db->order_by('tbl_aeng_mobile_slider.iOrder','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
    ...
    public function get_edit_home_detail() {
        ...
        $this->db->from('tbl_aeng_home_detail');
		$this->db->where('id',1);
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
    ...
    public function get_awards_list() {
        ...
        $this->db->from('tbl_aeng_awards');
		$this->db->order_by('tbl_aeng_awards.iOrder','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
    ...
    public function get_proof_confidence_list() {
        ...
        $this->db->from('tbl_aeng_proof_confidence');
		$this->db->order_by('tbl_aeng_proof_confidence.iOrder','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
...
public function get_careers_content_list() {
        ...
        $this->db->from('tbl_aeng_career_cv');
        $this->db->order_by('tbl_aeng_career_cv.dDateTime','desc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
    ...
    public function get_innerpage_list() {
        ...
        $this->db->from('tbl_aeng_page_details');
		$this->db->order_by('tbl_aeng_page_details.vPageName','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
    ...
    public function get_innerpage_banner_list() {
        ...
        $this->db->from('tbl_aeng_innerpage_banner');
		$this->db->order_by('tbl_aeng_innerpage_banner.vPageRoute','asc');
        $query = $this->db->get();
       // echo $this->db->last_query();exit();
        if ($query->num_rows() > 0) {
            return $query->result();
