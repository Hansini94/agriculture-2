...
class Ajax_flxi_model extends CI_Model {
    ...
    public function get_grid_data_join_reporteduser($valid_fields) {
        ...
        $this->db->from('tbl_aeng_report_user');
        $this->db->join('tbl_aeng_frontend_user', 'tbl_aeng_frontend_user.id = tbl_aeng_report_user.iUserid');
        ...
        $this->db->select('count(tbl_aeng_report_user.id) as record_count');
        $this->db->from('tbl_aeng_report_user');
        $this->db->join('tbl_aeng_frontend_user', 'tbl_aeng_frontend_user.id = tbl_aeng_report_user.iUserid');
