<?php
if ($cSaveStatus == "E") {
    $SeriesId = $this->uri->segment(6);
    $id = $edit_data['id'];   
	$fImage = $edit_data['fImage'];  
    $vName = $edit_data['vName'];  
    $vNumber = $edit_data['vNumber'];
    $vSeries = $edit_data['vSeries'];  
	$iOrder = $edit_data['iOrder'];   
    $cEnable = $edit_data['cEnable'];
	
} else {
    $SeriesId = $this->uri->segment(5);
    $id = "";    
	$fImage = "";  
    $vName = ""; 
    $vNumber = ""; 
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                            <h2>Economic & Applied Entomology</h2>
                        </div>
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                <?php if($cSaveStatus == "E") { ?>
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/student/economic_applied_entomology/'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add student</span>&nbsp;</a></li>
                                <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/student/economic_applied_entomology/save_series'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/student/economic_applied_entomology/'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td><?php echo $rowlist->vNumber;?></td>                                        
                                            <td><?php echo $rowlist->iOrder;?></td>   
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/student/economic_applied_entomology/edit/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/student/economic_applied_entomology/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/student/economic_applied_entomology/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
