    ...
    <div class="row">
        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row ms-auto">
                ...
                <img src="<?php echo base_url('front_img/').$faculty_map_data->fFacultyMap; ?>" alt="" class="dd-block w-100">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <a href="<?php echo base_url('front_img/').$faculty_map_data->fGrndFlrMap; ?>" data-toggle="lightbox" data-gallery="example-gallery" target="_blank">
                        <img src="<?php echo base_url('front_img/').$faculty_map_data->fGrndFlrMap; ?>" class="img-fluid">
                    </a>
                </div>

                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <a href="<?php echo base_url('front_img/').$faculty_map_data->fFstFlrMap; ?>" data-toggle="lightbox" data-gallery="example-gallery" target="_blank">
                        <img src="<?php echo base_url('front_img/').$faculty_map_data->fFstFlrMap; ?>" class="img-fluid">
                    </a>
                </div>

                <div
                    class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-12">
                    <a href="<?php echo base_url('front_img/').$faculty_map_data->fSecFlrMap; ?>" data-toggle="lightbox" data-gallery="example-gallery" target="_blank">
                        <img src="<?php echo base_url('front_img/').$faculty_map_data->fSecFlrMap; ?>" class="img-fluid">
                    </a>
                </div>
