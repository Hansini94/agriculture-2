        ...
        <h1 class="heading"><?php echo $centers->vTitle2; ?></h1>
          ...
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
            <div class="gray_text_div">
              ...
              <!-- arrow link -->
                <a class='animated-arrow' href='http://localhost/agriculture_local/abc/' target="_blank">
          ...
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
            <div class="gray_text_div">
              ...
              <!-- arrow link -->
                <a class='animated-arrow' href='http://localhost/agriculture_local/agbc/' target="_blank">
                <span class='the-arrow -left'>
                  <span class='shaft'></span>
                </span>
                <span class='main'>
          ...
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
            <div class="gray_text_div">
              ...
              <!-- arrow link -->
                <a class='animated-arrow' href='http://localhost/agriculture_local/aeu/' target="_blank">
                <span class='the-arrow -left'>
                  <span class='shaft'></span>
                </span>
                <span class='main'>
          ...
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
            <div class="gray_text_div">
              ...
              <!-- arrow link -->
                <a class='animated-arrow' href='http://localhost/agriculture_local/gewiu' target="_blank">
                <span class='the-arrow -left'>
                  <span class='shaft'></span>
                </span>
                <span class='main'>
