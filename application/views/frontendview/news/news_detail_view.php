                 ...
                 <div class="news_div">
                  ...
                  <div class="row">
                      <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                        <img src="<?php echo base_url().'/front_img/'.$all_data->fThumbnail;?>" class="d-block w-100" alt="..." style="float:left; width:100px;height:100px;object-fit:cover;">
                      </div>
                      ...
                      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h1 class="sub_heading">
                          <?php 
                            ...
                            echo substr($all_data->vName,0,60).'...';
                            // echo $all_data->vName; 
                          ?>
                        </h1>
                      </a>
