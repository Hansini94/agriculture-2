        ...
        <div class="inner_page_top_img" style="background: url(<?php echo base_url("assets/frontend/"); ?>images/shading.png) left center no-repeat, url(<?php echo base_url("assets/frontend/"); ?>images/slider01.jpg) center top repeat;">
          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              <h1 class="heading" data-aos="fade-up"> Committee  </h1>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <br>
                   ...
                   <div class="row">
                   <?php $i=0; foreach($current as $cur){ ?>
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 dean_div">
                      <img src="<?php echo base_url().'/front_img/'.$cur->fImg;?>" alt="" class="d-block w-100 rounded-circle" data-aos="fade-down" style="border: 2px solid #ad9d8e;">
                      <div class="gray_text_div dean_des_div">

                        <blockquote class="blockquote">
                          <p class="sub_heading"><?php echo $cur->vName ?></p>
                        </blockquote>
                        <figcaption class="blockquote-footer">
                          <?php echo $cur->tContent ?>
                        </figcaption>
                        <!-- <figcaption class="blockquote-footer" style="margin-bottom: 0px;">
                         Proposed by Department of Crop Science
                        </figcaption> -->
                      </div>
                    </div>
                    <?php $i++; 
