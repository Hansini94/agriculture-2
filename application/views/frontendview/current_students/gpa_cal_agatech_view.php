       ...
       <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row m-auto">
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <img src="<?php echo base_url().'/front_img/'.$agtech->fImg; ?>" class="d-block w-100" alt="...">
          </div>

          <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <h1 class="sub_heading"><?php echo $agtech->vTitle; ?></h1>
            <p data-aos="fade-up">
            <?php echo $agtech->tContent; ?>
           </p>
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                  <div class="gray_text_div">
                    ...
                    <!-- arrow link -->
                      <a class='animated-arrow' href='<?php echo base_url().'/front_img/'.$agtech->fFileExcel; ?>' target="_blank">
