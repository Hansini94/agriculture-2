          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Student Engagements</b></li>
              </ol>
            </nav>
            </div>
          </div>
    ...
    <div class="row">
       ...
       <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row m-auto">
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $latest->dDate; ?></small></p>
            <h1 class="sub_heading"><?php echo $latest->vName; ?></h1>
            <p data-aos="fade-up">
            <?php 
            ...
            <!-- arrow link -->
                <a class='animated-arrow' href='<?php echo base_url('engagement/st_detail/'.$latest->id) ?>'>
          ...
          <div class="news_div">
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <!-- arrow link -->
                    <a class='animated-arrow' href='<?php echo base_url('engagement/st_detail/'.$all_data->id) ?>'>
                    <span class='the-arrow -left'>
                      <span class='shaft'></span>
                    </span>
                    <span class='main'>
