        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <h1 class="sub_heading">
                <?php 
                    $str = $featured_news[0]->vName;
                    $len = str_word_count($str);
                    
                    echo substr($featured_news[0]->vName,0,60).'...';
                    
                    // echo $featured_news[0]->vName; 
                ?>
            </h1>
            <!-- arrow link -->
            <a class='animated-arrow' href='<?php 
      ...
      <div class="news_div">
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <h1 class="sub_heading">
                <?php 
                    $str = $featured_news[2]->vName;
                    $len = str_word_count($str);
                    
                    echo substr($featured_news[2]->vName,0,60).'...';
                    // echo $featured_news[2]->vName; 
                ?>
            </h1>
            <!-- arrow link -->
            <a class='animated-arrow' href='<?php 
