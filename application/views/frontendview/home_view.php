            ...
            <div class="row">
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="border-left: 1px solid #999999; padding-top: 15px;">
                <h1 style="text-transform: capitalize; font-size: 17px; color: #f82525;">
                  <?php echo $home_details[0]->vOtherTitle; ?>
                </h1>
              </div>
            </div>
          </a>
...
<!-- numbering section -->
<div class="container-fluid no_padding footer_row  angled-top-right" style="margin-bottom: 5px; padding-bottom: 20px; padding-top: 0px; background-color: #ddc1bd;">
  ...
  <div class="container">
    ...
    <div id="counter">
      ...
      <div class="row">
        ...
        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 p-1">
          <img src="<?php echo base_url('front_img/').$home_details[0]->fNoOfStaff; ?>" class="img-fluid mx-auto d-block" style="width: 80px;" data-aos="fade-down">
          <div class="heading counter-value mt-2" data-count="<?php echo $home_details[0]->iNoOfStaff; ?>" style="text-align: center;"><?php echo $home_details[0]->iNoOfStaff; ?>+</div>
          <h1 class="sub_heading mt-1" style="text-align: center;">Number of staff</h1>
        </div>

        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 p-1">
          <img src="<?php echo base_url('front_img/').$home_details[0]->fNoOfStudent; ?>" class="img-fluid mx-auto d-block" style="width: 80px;" data-aos="fade-up">
          <div class="heading counter-value mt-2" data-count="<?php echo $home_details[0]->iNoOfStudent; ?>" style="text-align: center;"><?php echo $home_details[0]->iNoOfStudent; ?>+</div>
          <h1 class="sub_heading mt-1" style="text-align: center;">Number of students </h1>
        </div>

        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 p-1">
          <img src="<?php echo base_url('front_img/').$home_details[0]->fStudentStaffRatio; ?>" class="img-fluid mx-auto d-block" style="width: 80px;" data-aos="fade-down">
          <div class="heading counter-value mt-2" data-count="<?php echo $home_details[0]->iStudentStaffRatio; ?>" style="text-align: center;"><?php echo $home_details[0]->iStudentStaffRatio; ?></div>
          <h1 class="sub_heading mt-1" style="text-align: center;">Student to staff ratio</h1>
        </div>

        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 p-1">
          <img src="<?php echo base_url('front_img/').$home_details[0]->fFieldsOfStudy; ?>" class="img-fluid mx-auto d-block" style="width: 80px;" data-aos="fade-up">
          <div class="heading counter-value mt-2" data-count="<?php echo $home_details[0]->iFieldsOfStudy; ?>" style="text-align: center;"><?php echo $home_details[0]->iFieldsOfStudy; ?>+</div>
          <h1 class="sub_heading mt-1" style="text-align: center;">Fields of study</h1>
        </div>
  ...
  <div class="container">
    ...
    <div class="row d-lg-none d-xl-none d-xxl-none" style="margin-bottom: 30px;">
      ...
      <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-8">
        <h1 class="heading"><?php echo $home_details[0]->vFacultyTitle; ?></h1>
        <p data-aos="fade-up">
          <?php echo substr($home_details[0]->tFacultyContent, 0, 140); ?>
        </p>
      </div>
      <!-- uni about section -->
    </div>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 p-1">
      <div class="short_link_div short_link_div_middle_height mb-2" style="background-image: url(<?php echo base_url("front_img/").$home_details[0]->fOtherImage2; ?>) !important; background-position:center top;">
      <h1 class="heading" style="text-transform: uppercase; color: #ffffff;"><?php echo $home_details[0]->vOtherTitle2; ?></h1>
        <p data-aos="fade-up" style="text-transform: uppercase; color: #ffffff;">
      ...
      <div class="short_link_div short_link_div_middle_height" style="background-image: url(<?php echo base_url("front_img/").$home_details[0]->fOtherImage3; ?>); background-position:center top;">
