                ...
                <div class="row ms-auto">
                    ...
                    <nav aria-label="breadcrumb" data-aos="fade-down">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('class-timetables'); ?>">Current Undergraduates</a></li>
                            <li class="breadcrumb-item"><a href="#">Academic</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><b>Class Timetables</b></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row ms-auto">
                ...
                <div class="">
                    ...
                    <div class="accordion" id="accordionExample">
                        <?php 
                            $count = 0;
                            foreach($class_timetables as $timetable) { 
                        ?>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne_<?php echo $timetable->id; ?>">
                                <button class="accordion-button" type="button <?php if($count!=0) { echo "collapsed"; } ?>" data-bs-toggle="collapse"
                            ...
                            <div id="collapseOne_<?php echo $timetable->id; ?>" class="accordion-collapse collapse <?php if($count == 0){ echo "show"; } ?>" aria-labelledby="headingOne_<?php echo $timetable->id; ?>"
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6">
                                            <div class="gray_text_div">
                                                ...
                                                <blockquote class="blockquote" style="margin-bottom: 0px;">
                                                    <p class="sub_heading">Time Table</p>
                                                </blockquote>
                                                <!-- arrow link -->
