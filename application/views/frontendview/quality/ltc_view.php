          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Language Training Committee (LTC)</b></li>
              </ol>
            </nav>
            </div>
          </div>
          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row ms-auto">
              ...
              <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                ...
                <?php $members = get_committee_members($committee[0]->id, 'tbl_teaching_committee_composition'); ?>
                 <!-- table-->
               ...
               <div class="row">
                ...
                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                  <div class="gray_text_div">
                    ...
                    <!-- arrow link -->
                      <a class='animated-arrow' href='<?php echo base_url('quality/ltc/').$committee[1]->vYear; ?>'>
