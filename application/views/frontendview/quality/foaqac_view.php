          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row ms-auto">
              ...
              <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                ...
                <?php echo $member_of_foaqac->tContent1; ?>
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-6 col-12">
                  <div class="gray_text_div">
                    ...
                    <blockquote class="blockquote" style="margin-bottom: 0px;">
                      <p class="sub_heading">View Members</p>
                    </blockquote>
                    <!-- arrow link -->
                      <a class='animated-arrow' target="_blank" href='<?php echo base_url(); ?>quality/member_of_foaqac'>
