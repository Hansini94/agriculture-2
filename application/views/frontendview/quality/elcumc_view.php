          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>E-Learning & Computer Unit Management Committee (ELCUMC)</b></li>
              </ol>
            </nav>
            </div>
          </div>
          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row ms-auto">
              ...
              <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                ...
                <?php $members = get_committee_members($committee[0]->id, 'tbl_computer_unit_composition'); ?>
                 <!-- table-->
               ...
               <div class="row">
                ...
                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                  <div class="gray_text_div">
                    ...
                    <!-- arrow link -->
                      <a class='animated-arrow' href='<?php echo base_url('quality/elcumc/').$committee[1]->vYear; ?>'>
