          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Downloads</b></li>
              </ol>
            </nav>
            </div>
          </div>
      ...
      <div class="accordion" id="accordionExample">
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
              ...
              <div class="row">
                <?php $i=0; foreach($general as $gen){ ?>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-4">
                    ...
                    <div class="down_div" style="background-color: #f2fde3; padding: 20px 20px 0px 20px;">
                        ...
                        <p class="sub_heading"><?php echo $gen->vTitle; ?></p>
                        ...
                        <div class="row">
                            ...
                            <div class="gray_text_div">
                                ...
                                <!-- arrow link -->
                                <a class='animated-arrow' href='<?php echo base_url().'/front_img/'.$gen->fFilePdf; ?>' target="_blank">
                            ...
                            <div class="gray_text_div">
                                ...
                                <!-- arrow link -->
                                <a class='animated-arrow' href='<?php echo base_url().'/front_img/'.$gen->fFileWord; ?>' target="_blank">
                                <span class='the-arrow -left'>
                                    <span class='shaft'></span>
                                </span>
                                <span class='main'>
        ...
        <div class="accordion-item">
          ...
          <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
            ...
            <div class="row">
                <?php $i=0; foreach($research as $res){ ?>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-4">

                    <div class="down_div" style="background-color: #f2fde3; padding: 20px 20px 0px 20px;">

                        <p class="sub_heading"><?php echo $res->vTitle; ?></p>
                        ...
                        <div class="row">
                            ...
                            <div class="gray_text_div">
                                ...
                                <!-- arrow link -->
                                <a class='animated-arrow' href='<?php echo base_url().'/front_img/'.$res->fFilePdf; ?>' target="_blank">
                                <span class='the-arrow -left'>
                                    <span class='shaft'></span>
                                </span>
                                <span class='main'>
                            ...
                            <div class="gray_text_div">
                                ...
                                <!-- arrow link -->
                                <a class='animated-arrow' href='<?php echo base_url().'/front_img/'.$res->fFileWord; ?>' target="_blank">
                                <span class='the-arrow -left'>
                                    <span class='shaft'></span>
                                </span>
                                <span class='main'>
