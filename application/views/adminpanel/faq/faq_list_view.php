<?php
if ($cSaveStatus == "E") {
    $faqId = $this->uri->segment(6);
    $id = $edit_question['id'];   
	$tContent = $edit_question['tContent'];  
    $vTitle = $edit_question['vTitle']; 
	$iOrder = $edit_question['iOrder'];   
    $cEnable = $edit_question['cEnable'];
	
} else {
    $faqId = $this->uri->segment(5);
    $id = "";    
	$tContent = "";  
    $vTitle = "";  
    $iOrder = "";  
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                ...
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/faq/faq/add_question/'.$faqId); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Question</span>&nbsp;</a></li>
                                <?php } else { ?>
                                <li><a class="collapse-link" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Question</span>&nbsp;<i class="fa fa-chevron-down"></i></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                    ...
                    ?>>
                        <br />
                        <form id="edit_question" name="edit_question" action="<?php echo base_url('adminpanel/faq/faq/save_question'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <input type="hidden" id="iFaqId" name="iFaqId" value="<?php echo $faqId ?>">
                                    <input type="hidden" id="cSaveStatus" name="cSaveStatus" value="<?php echo $cSaveStatus; ?>">
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/faq/faq/add_question/'.$faqId); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/faq/faq/edit_question/$recordid/$iFaqId" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/faq/faq/change_status_question/status/$recordid/$iFaqId" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/faq/faq/delete_record_question/delete/$recordid/$iFaqId" ?>" onclick="return confirm('Are you sure?')">
