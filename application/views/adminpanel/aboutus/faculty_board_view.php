                        ...
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/about_us/faculty_board/save_faculty_board'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tDescription1" id="tDescription1" class="form-control col-md-7 col-xs-12" required><?php echo $tDescription1; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tDescription1); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tDescription2" id="tDescription2" class="form-control col-md-7 col-xs-12" required><?php echo $tDescription2; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tDescription2); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="vProTitle">Composition of the Faculty Board of Agriculture<span class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/about_us/faculty_board'); ?>';">Cancel</button>
