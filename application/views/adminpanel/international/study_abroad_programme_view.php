<?php
if ($cSaveStatus == "E") {
    $id = $abroad_pro_data[0]->id;
    $vUrl = $abroad_pro_data[0]->vUrl;
    $cEnable = $abroad_pro_data[0]->cEnable;
} else {
    $id = '';
    $vUrl = '';
    $cEnable = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>Study Abroad Programme for Foreign Universities</h2>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_excellence_award" name="edit_excellence_award" action="<?php echo base_url('adminpanel/international/study_abroad_programme/save_study_abroad_pro'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/international/study_abroad_programme'); ?>';">Cancel</button>
