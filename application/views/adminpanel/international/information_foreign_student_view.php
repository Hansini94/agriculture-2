                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>Information for Foreign Students</h2>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <form id="edit_information_foreign_student" name="edit_information_foreign_student" action="<?php echo base_url('adminpanel/international/information_foreign_student/save_information_foreign_student'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="item form-group">                                    
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name" >For More Details<span class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12" style="padding-top:8px;">
                                        <input type="file" id="fMoreDetailsPdf" name="fMoreDetailsPdf"<?php
                                ...
                                <div class="form-group" id="pdf_delete_<?php echo $id; ?>">
                                    ...
                                    <a href="<?php echo base_url().'front_img/'.$fMoreDetailsPdf;?>" target="_blank"> View PDF Document</a>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="item form-group">                                    
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name" >Foreign Students Handbook<span class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12" style="padding-top:8px;">
                                        <input type="file" id="fStudentHandBook" name="fStudentHandBook"<?php
                                        if ($cSaveStatus != "E") {?> required  <?php } ?>>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="pdf_delete_<?php echo $id; ?>">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="vProTitle">&nbsp;</label>
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                    <a href="<?php echo base_url().'front_img/'.$fStudentHandBook;?>" target="_blank"> View PDF Document</a>
