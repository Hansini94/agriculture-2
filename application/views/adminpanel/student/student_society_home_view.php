<?php
if ($cSaveStatus == "E") {
    $id = $content_data[0]->id;
    $vTitleMain = $content_data[0]->vTitleMain;
    $tContentMain = $content_data[0]->tContentMain;
    $vTitleSub = $content_data[0]->vTitleSub ;
    $tContentSub  = $content_data[0]->tContentSub ;
    $fImg = $content_data[0]->fImg;
    $cEnable = $content_data[0]->cEnable;
} else {
    $id = '';
    $vTitleMain = '';
    $tContentMain = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="content_data" name="content_data" action="<?php echo base_url('adminpanel/student/student_society_home/save_content'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tContentMain" id="tContentMain" class="form-control col-md-7 col-xs-12" required><?php echo $tContentMain; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tContentMain); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tContentSub" id="tContentSub" class="form-control col-md-7 col-xs-12" required><?php echo $tContentSub; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tContentSub); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/student/student_society_home'); ?>';">Cancel</button>
