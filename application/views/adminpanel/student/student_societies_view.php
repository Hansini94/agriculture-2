...
if ($cSaveStatus == "E") {
    ...
    $vSubtitle = $edit_data['vSubtitle'];
	$tContent = $edit_data['tContent'];  
	$fImgRight = $edit_data['fImgRight'];  
	$fImgLeft = $edit_data['fImgLeft'];  
    $tContentRight = $edit_data['tContentRight'];  
    $tContentLeft = $edit_data['tContentLeft'];  
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    <div class="x_title">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                ...
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/student/student_societies'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Socity</span>&nbsp;</a></li>
                                <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/student/student_societies/save_societies'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                        
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-12 col-xs-12" for="vProTitle">Society Name<span class="required">*</span></label>
                                    <div class="col-md-9 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name" >Left Image (1200 * 800px) </label>
                                    <div class="col-md-5 col-sm-6 col-xs-10" style="padding-top:8px;">
                                        <input type="file" id="fImgLeft" name="fImgLeft" >
                                    </div>                                    
                                </div>                                
                                ...
                                <div class="form-group" id="image_delete_<?php echo $id; ?>">
                                    ...
                                    <div class="col-md-7 col-sm-6 col-xs-10">
                                        <img class="img-responsive" src="<?php echo base_url().'/front_img/'.$fImgLeft;?>"  style="width:250px;" />
                                    </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="vProTitle">Right Content<span class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tContentRight" id="tContentRight" class="form-control col-md-7 col-xs-12" required><?php echo $tContentRight; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tContentRight); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name" >Right Image (1200 * 800px) </label>
                                    <div class="col-md-5 col-sm-6 col-xs-10" style="padding-top:8px;">
                                        <input type="file" id="fImgRight" name="fImgRight" >
                                    </div>                                    
                                </div>                                
                                ...
                                <div class="form-group" id="image_delete_<?php echo $id; ?>">
                                    <label class="control-label col-md-4 col-sm-3 col-xs-12" for="vProTitle">&nbsp;</label>
                                    <div class="col-md-7 col-sm-6 col-xs-10">
                                        <img class="img-responsive" src="<?php echo base_url().'/front_img/'.$fImgRight;?>"  style="width:250px;" />
                                    </div>
                                    <!-- <div class="col-md-1 col-sm-3 col-xs-2" >
                                        <span class="glyphicon glyphicon-trash" style="line-height:30px; cursor:pointer;" onclick="delete_image('<?php echo $id; ?>');" title="Delete Link"></span>
                                    </div> -->
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="vProTitle">Left Content<span class="required">*</span></label>
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="15" name="tContentLeft" id="tContentLeft" class="form-control col-md-7 col-xs-12" required><?php echo $tContentLeft; ?></textarea>
                                        <?php echo display_ckeditor($ckeditor_tContentLeft); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/student/student_societies'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td><?php echo $rowlist->vSubtitle;?></td> 
                                            <td><?php echo $rowlist->iOrder;?></td> 
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/student/student_societies/edit/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/student/student_societies/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/student/student_societies/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
