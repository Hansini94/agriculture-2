<?php
if ($cSaveStatus == "E") {
    $id = $calling_application_data[0]->id;
    $vTitle = $calling_application_data[0]->vTitle;
    $vYear = $calling_application_data[0]->vYear;
    $tContent = $calling_application_data[0]->tContent;
    $cEnable = $calling_application_data[0]->cEnable;
} else {
    $id = '';
    $vTitle = '';
    $vYear = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_excellence_award" name="edit_excellence_award" action="<?php echo base_url('adminpanel/awards/calling_application/save_calling_application'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/awards/calling_application'); ?>';">Cancel</button>
