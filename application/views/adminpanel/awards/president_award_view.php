<?php
if ($cSaveStatus == "E") {
    $id = $edit_president_award[0]->id;  
    $vTitle = $edit_president_award[0]->vTitle; 
    $vName = $edit_president_award[0]->vName;  
    $vDepartment = $edit_president_award[0]->vDepartment; 
    $fImage = $edit_president_award[0]->fImage;  
    $iOrder = $edit_president_award[0]->iOrder;
    $cEnable = $edit_president_award[0]->cEnable;
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>Presidents' Awards</h2>
                        </div>
                        <ul class="nav navbar-right col-md-3 col-sm-3 col-xs-3">                           
                            <?php if($cSaveStatus == "E") { ?>
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/awards/president_award'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark" style="color:#FFF;">Add Award</span>&nbsp;<i class="fa fa-chevron-down"></i></a></li>
                            <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_president_award" name="edit_president_award" action="<?php echo base_url('adminpanel/awards/president_award/save_president_award'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/awards/president_award/edit_president_award/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/awards/president_award/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/awards/president_award/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
