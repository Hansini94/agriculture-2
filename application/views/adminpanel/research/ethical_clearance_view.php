<?php
if ($cSaveStatus == "E") {
    $id = $edit_ethical_clearance[0]->id;  
	$vTitle = $edit_ethical_clearance[0]->vTitle;  
    $fFile = $edit_ethical_clearance[0]->fFile; 
    $iOrder = $edit_ethical_clearance[0]->iOrder;
    $cEnable = $edit_ethical_clearance[0]->cEnable;
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>Ethical Clearance Committee</h2>
                        </div>
                        <ul class="nav navbar-right col-md-3 col-sm-3 col-xs-3">                           
                            <?php if($cSaveStatus == "E") { ?>
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/research/ethical_clearance'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark" style="color:#FFF;">Add Ethical Clearance</span>&nbsp;<i class="fa fa-chevron-down"></i></a></li>
                            <?php } else { ?>
                            <li><a class="collapse-link" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Ethical Clearance</span>&nbsp;<i class="fa fa-chevron-down"></i></a></li>
                            <?php } ?>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    ?>>
                        <br />
                        <form id="edit_ethical_clearance" name="edit_ethical_clearance" action="<?php echo base_url('adminpanel/research/ethical_clearance/save_ethical_clearance'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">                                    
                                    ...
                                    <div class="col-md-8 col-sm-7 col-xs-12" style="padding-top:8px;">
                                        <input type="file" id="fFile" name="fFile"<?php
                                ...
                                <div class="form-group" id="pdf_delete_<?php echo $id; ?>">
                                    ...
                                    <div class="col-md-8 col-sm-7 col-xs-12">
                                    <a href="<?php echo base_url().'front_img/'.$fFile;?>" target="_blank"> View Document</a>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/research/ethical_clearance'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/research/ethical_clearance/edit_ethical_clearance/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/research/ethical_clearance/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/research/ethical_clearance/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
