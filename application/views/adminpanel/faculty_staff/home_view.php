...
if ($cSaveStatus == "E") {
    ...
    $vSubTitle = $edit_date[0]->vSubTitle;
    $tSubContent = $edit_date[0]->tSubContent;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/faculty_staff/home/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">                           
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        ...
                                        <a href="<?php echo base_url().'adminpanel/faculty_staff/home/remove_image/'.$id.'/fImg/'.$fImg;?>">Remove image</a> 
                                    </div>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/faculty_staff/home'); ?>';">Cancel</button>
