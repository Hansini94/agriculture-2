                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right ">
                            <!-- <li><a class="collapse-link" href="<?php echo base_url('adminpanel/faculty_staff/declaration_form'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li> -->
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/faculty_staff/declaration_form/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">                                
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <a href="<?php echo base_url().'/front_img/'.$fFile;?>" target="_blank">View</a>
                                    </div>
                                </div>
								<?php } ?> 
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/faculty_staff/declaration_form'); ?>';">Cancel</button>
