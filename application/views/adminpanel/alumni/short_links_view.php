<?php
if ($cSaveStatus == "E") {
    $id = $edit_short_links[0]->id;    
    $fImage = $edit_short_links[0]->fImage;
    $vTitle = $edit_short_links[0]->vTitle;
    $vCaption = $edit_short_links[0]->vCaption;
    $iOrder = $edit_short_links[0]->iOrder;
    $cEnable = $edit_short_links[0]->cEnable;
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    ?>>
                        <br />
                        <form id="Edit_hotel" name="Edit_hotel" action="<?php echo base_url('adminpanel/alumni/short_links/save_short_links'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/alumni/short_links'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><?php echo $rowlist->vTitle; ?></td>                                          
                                            <td style="text-align:center;"><?php echo $rowlist->iOrder; ?></td>                                            
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/alumni/short_links/edit_short_links/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/alumni/short_links/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/alumni/short_links/delete_record/$recordid" ?>" onclick="return confirm('Are you sure?')">
