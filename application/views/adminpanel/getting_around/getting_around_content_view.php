...
if ($cSaveStatus == "E") {
    ...
    $vHeading = $content_data[0]->vHeading;
    $tContent = $content_data[0]->tContent;
    $fImage = $content_data[0]->fImage;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_aboutus" name="edit_aboutus" action="<?php echo base_url('adminpanel/getting_around/getting_around_content/save_getting_around_content'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/getting_around/getting_around_content'); ?>';">Cancel</button>
