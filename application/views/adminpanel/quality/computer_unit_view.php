<?php
if ($cSaveStatus == "E") {
    $id = $computer_unit_data[0]->id;
    $vTitle = $computer_unit_data[0]->vTitle;
    $tDescription = $computer_unit_data[0]->tDescription;
    $vSubtitle = $computer_unit_data[0]->vSubtitle;
    $vChairman = $computer_unit_data[0]->vChairman;
    $vSecretary = $computer_unit_data[0]->vSecretary;
    $cEnable = $computer_unit_data[0]->cEnable;
    $fImgChairman = $computer_unit_data[0]->fImgChairman ;
    $fImgSecretary = $computer_unit_data[0]->fImgSecretary ;
} else {
    $id = '';
    $vTitle = '';
    $tDescription = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right ">
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/computer_unit_composition'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li>
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/computer_unit/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
