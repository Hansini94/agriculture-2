        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                ...
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/welfare_committee'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Committee</span>&nbsp;</a></li>
                                <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/quality/welfare_committee/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group" id="image_delete_<?php echo $id; ?>">
                                    ...
                                    <div class="col-md-7 col-sm-6 col-xs-10">
                                        ...
                                        <a onclick="return confirm('Are you sure?')" href="<?php echo base_url().'adminpanel/quality/welfare_committee/remove_image/'.$id.'/fImgChairman/'.$fImgChairman;?>">Remove image</a> 
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group" id="image_delete_<?php echo $id; ?>">
                                    ...
                                    <div class="col-md-7 col-sm-6 col-xs-10" >
                                        ...
                                        <a onclick="return confirm('Are you sure?')" href="<?php echo base_url().'adminpanel/quality/welfare_committee/remove_image/'.$id.'/fImgSecretary/'.$fImgSecretary;?>">Remove image</a> 
                                    </div>
                                    <!-- <div class="col-md-1 col-sm-3 col-xs-2" >
                                        <span class="glyphicon glyphicon-trash" style="line-height:30px; cursor:pointer;" onclick="delete_image('<?php echo $id; ?>');" title="Delete Link"></span>
                                    </div> -->
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/quality/welfare_committee/composition/$recordid" ?>" target="_blank">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/quality/welfare_committee/edit/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/quality/welfare_committee/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/quality/welfare_committee/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
