            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                            <h2>Publications And Public Relations Committee</h2>
                        </div>
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                <?php if($cSaveStatus == "E") { ?>
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/public_relations_committee_composition'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Period</span>&nbsp;</a></li>
                                <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_period" name="edit_period" action="<?php echo base_url('adminpanel/quality/public_relations_committee_composition/save_data'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/quality/public_relations_committee_composition'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/quality/public_relations_committee_composition/add_composition/$recordid" ?>" target="_blank">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/quality/public_relations_committee_composition/edit/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/quality/public_relations_committee_composition/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i></a>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/quality/public_relations_committee_composition/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
