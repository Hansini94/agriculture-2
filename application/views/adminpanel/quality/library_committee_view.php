<?php
if ($cSaveStatus == "E") {
    $id = $library_committee_data[0]->id;
    $vTitle = $library_committee_data[0]->vTitle;
    $tDescription = $library_committee_data[0]->tDescription;
    $vSubtitle = $library_committee_data[0]->vSubtitle;
    $vChairman = $library_committee_data[0]->vChairman;
    $vSecretary = $library_committee_data[0]->vSecretary;
    $cEnable = $library_committee_data[0]->cEnable;
    $fImgChairman = $library_committee_data[0]->fImgChairman ;
    $fImgSecretary = $library_committee_data[0]->fImgSecretary ;
} else {
    $id = '';
    $vTitle = '';
    $tDescription = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right ">
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/library_committee_composition'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li>
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/library_committee/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
