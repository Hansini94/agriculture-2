<?php
if ($cSaveStatus == "E") {
    $id = $curriculum_development_committee_data[0]->id;
    $vTitle = $curriculum_development_committee_data[0]->vTitle;
    $tDescription = $curriculum_development_committee_data[0]->tDescription;
    $vSubtitle = $curriculum_development_committee_data[0]->vSubtitle;
    $vChairman = $curriculum_development_committee_data[0]->vChairman;
    $vSecretary = $curriculum_development_committee_data[0]->vSecretary;
    $cEnable = $curriculum_development_committee_data[0]->cEnable;
    $fImgChairman = $curriculum_development_committee_data[0]->fImgChairman ;
    $fImgSecretary = $curriculum_development_committee_data[0]->fImgSecretary ;
} else {
    $id = '';
    $vTitle = '';
    $tDescription = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right ">
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/development_committee_composition'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li>
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/curriculum_development_committee/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
