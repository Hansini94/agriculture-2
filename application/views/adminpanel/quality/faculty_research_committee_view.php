<?php
if ($cSaveStatus == "E") {
    $id = $faculty_research_committee_data[0]->id;
    $vTitle = $faculty_research_committee_data[0]->vTitle;
    $tDescription = $faculty_research_committee_data[0]->tDescription;
    $vSubtitle = $faculty_research_committee_data[0]->vSubtitle;
    $vChairman = $faculty_research_committee_data[0]->vChairman;
    $vSecretary = $faculty_research_committee_data[0]->vSecretary;
    $cEnable = $faculty_research_committee_data[0]->cEnable;
    $fImgChairman = $faculty_research_committee_data[0]->fImgChairman ;
    $fImgSecretary = $faculty_research_committee_data[0]->fImgSecretary ;
} else {
    $id = '';
    $vTitle = '';
    $tDescription = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/faculty_research_committee/save_faculty_research_committee'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/quality/faculty_research_committee'); ?>';">Cancel</button>
