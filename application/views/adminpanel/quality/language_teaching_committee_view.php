<?php
if ($cSaveStatus == "E") {
    $id = $language_teaching_committee_data[0]->id;
    $vTitle = $language_teaching_committee_data[0]->vTitle;
    $tDescription = $language_teaching_committee_data[0]->tDescription;
    $vSubtitle = $language_teaching_committee_data[0]->vSubtitle;
    $vChairman = $language_teaching_committee_data[0]->vChairman;
    $vSecretary = $language_teaching_committee_data[0]->vSecretary;
    $cEnable = $language_teaching_committee_data[0]->cEnable;
    $fImgChairman = $language_teaching_committee_data[0]->fImgChairman ;
    $fImgSecretary = $language_teaching_committee_data[0]->fImgSecretary ;
} else {
    $id = '';
    $vTitle = '';
    $tDescription = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right ">
                            <li><a class="collapse-link" href="<?php echo base_url('adminpanel/quality/teaching_committee_composition'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li>
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/language_teaching_committee/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
