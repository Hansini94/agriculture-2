<?php
if ($cSaveStatus == "E") {
    $id = $functions_of_foaqac_data[0]->id;
    $vTitle1 = $functions_of_foaqac_data[0]->vTitle1;
    $tContent1 = $functions_of_foaqac_data[0]->tContent1;
    $vTitle2 = $functions_of_foaqac_data[0]->vTitle2;
    $tContent2 = $functions_of_foaqac_data[0]->tContent2;
    $cEnable = $functions_of_foaqac_data[0]->cEnable;
} else {
    $id = '';
    $vTitle1 = '';
    $tContent1 = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_history" name="edit_history" action="<?php echo base_url('adminpanel/quality/functions_of_foaqac/save_functions_of_foaqac'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="vProTitle">Heading 1<span class="required">*</span></label>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="10" name="tContent1" id="tContent1" class="form-control col-md-7 col-xs-12" required><?php echo $tContent1; ?></textarea>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea rows="10" name="tContent2" id="tContent2" class="form-control col-md-7 col-xs-12" required><?php echo $tContent2; ?></textarea>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/quality/functions_of_foaqac'); ?>';">Cancel</button>
