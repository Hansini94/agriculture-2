                                                ...
                                                <script type="text/javascript">                                                                                 
                                                    $('#slider_<?php echo $recordid; ?>').on('change', function (e) {
                                                        if ($(this).prop('checked')) {
                                                            window.location.href = '<?php echo base_url("adminpanel/home_page/news_updates/slider_active_record/$recordid"); ?>';
                                                        } else {
                                                            window.location.href = '<?php echo base_url("adminpanel/home_page/news_updates/slider_deactive_record/$recordid"); ?>';
                                                        }
                                                    });
                                            ...
                                            <td style="text-align:center; vertical-align: middle;">
                                                ...
                                                <script type="text/javascript">                                                                                 
                                                    $('#featured_<?php echo $recordid; ?>').on('change', function (e) {
                                                        if ($(this).prop('checked')) {
                                                            window.location.href = '<?php echo base_url("adminpanel/home_page/news_updates/featured_active_record/$recordid"); ?>';
                                                        } else {
                                                            window.location.href = '<?php echo base_url("adminpanel/home_page/news_updates/featured_deactive_record/$recordid"); ?>';
                                                        }
                                                    });
