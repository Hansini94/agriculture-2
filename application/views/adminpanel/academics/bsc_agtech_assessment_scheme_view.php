<?php
if ($cSaveStatus == "E") {
    $id = $assessment_scheme_data[0]->id;
    $iDegree = $assessment_scheme_data[0]->iDegree;
    $vHeading = $assessment_scheme_data[0]->vHeading;
    $tContent = $assessment_scheme_data[0]->tContent;
    $cEnable = $assessment_scheme_data[0]->cEnable;
} else {
    $id = '';
    $iDegree = '';
    $vHeading = '';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>B.Sc. Degree in Agricultural Technology and Management - Undergraduate Programme</h2>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_excellence_award" name="edit_excellence_award" action="<?php echo base_url('adminpanel/academics/bsc_agtech_assessment_scheme/save_bsc_assessment_scheme'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/academics/bsc_agtech_assessment_scheme'); ?>';">Cancel</button>
