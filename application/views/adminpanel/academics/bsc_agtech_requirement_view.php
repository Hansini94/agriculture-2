<?php
if ($cSaveStatus == "E") {
    $id = $requirement_data[0]->id;
    $iDegree = $requirement_data[0]->iDegree;
    $vHeading = $requirement_data[0]->vHeading;
    $tContent = $requirement_data[0]->tContent;
    $cEnable = $requirement_data[0]->cEnable;
} else {
    $id = '';
    $iDegree = '';
    $vHeading = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_excellence_award" name="edit_excellence_award" action="<?php echo base_url('adminpanel/academics/bsc_agtech_requirement/save_bsc_requirement'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/academics/bsc_agtech_requirement'); ?>';">Cancel</button>
