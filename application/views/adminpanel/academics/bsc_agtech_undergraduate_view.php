<?php
if ($cSaveStatus == "E") {
    $id = $undergraduate_data[0]->id;
    $iDegree = $undergraduate_data[0]->iDegree;
    $vHeading = $undergraduate_data[0]->vHeading;
    $tContent = $undergraduate_data[0]->tContent;
    $cEnable = $undergraduate_data[0]->cEnable;
} else {
    $id = '';
    $iDegree = '';
    $vHeading = '';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_excellence_award" name="edit_excellence_award" action="<?php echo base_url('adminpanel/academics/bsc_agtech_undergraduate/save_bsc_undergraduate'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/academics/bsc_agtech_undergraduate'); ?>';">Cancel</button>
