...
Class Sports extends CI_Controller {
    ...
    private $table_name = "tbl_student_sports";
    private $page_id = "258";
    private $redirect_path = "adminpanel/student/sports";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->student_model->get_sports_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/student/sports_view', $data);
        $this->load->view('adminpanel/footer_view');
    }

    public function save_sport($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/sports');
            } else {
	...
	public function edit() {
		...
		$data['edit_data'] = $this->student_model->get_edit_sports($recId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/student/sports_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
