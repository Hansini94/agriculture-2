...
Class Events extends CI_Controller {
    ...
    private $table_name = "tbl_student_events";
    private $page_id = "258";
    private $redirect_path = "adminpanel/student/events";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->student_model->get_events_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/student/events_view', $data);
    ...
    public function save_sport($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/events');
            } else {
	...
	public function edit() {
		...
		$data['edit_data'] = $this->student_model->get_edit_events($recId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/student/events_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
