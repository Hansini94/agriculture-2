...
Class Prospectus extends CI_Controller {
    ...
    private $page_id = "315";
    private $redirect_path = "adminpanel/students/prospectus";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/students/prospectus_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_prospectus')) {
                ...
                redirect(base_url() . 'adminpanel/students/prospectus');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/students/prospectus/update_details/".$imageID);
            } else {
