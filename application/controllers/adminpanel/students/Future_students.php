...
Class Future_students extends CI_Controller {
    ...
    private $page_id = "311";
    private $redirect_path = "adminpanel/students/future_students";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/students/future_students_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_fs_home')) {
                ...
                redirect(base_url() . 'adminpanel/students/future_students');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/students/future_students/update_details/".$imageID);
            } else {
