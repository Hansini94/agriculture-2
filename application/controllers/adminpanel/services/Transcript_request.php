...
Class Transcript_request extends CI_Controller {

    private $table_name = "tbl_transcript_request";
    private $page_id = "291";
    private $redirect_path = "adminpanel/services/transcript_request";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/services/transcript_request_view', $data);
    ...
    public function save_request($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/services/transcript_request');
            } else {
