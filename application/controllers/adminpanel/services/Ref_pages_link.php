...
Class Ref_pages_link extends CI_Controller {

    private $table_name = "tbl_ref_links";
    private $page_id = "298";
    private $redirect_path = "adminpanel/services/ref_pages_link";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/services/ref_pages_link_view', $data);
    ...
    public function save_request($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/services/ref_pages_link');
            } else {
