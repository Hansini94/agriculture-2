...
Class current_students extends CI_Controller {
    ...
    private $page_id = "313";
    private $redirect_path = "adminpanel/current_students/current_students";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/current_students/current_students_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_cs_home')) {
                ...
                redirect(base_url() . 'adminpanel/current_students/current_students');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/current_students/current_students/update_details/".$imageID);
            } else {
