...
Class Academic_calender extends CI_Controller {
    ...
    private $page_id = "316";
    private $redirect_path = "adminpanel/current_current_students/academic_calender";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/current_students/academic_calender_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_academic_calender')) {
                ...
                redirect(base_url() . 'adminpanel/current_students/academic_calender');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/current_students/academic_calender/update_details/".$imageID);
            } else {
