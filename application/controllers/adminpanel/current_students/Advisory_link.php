...
Class Advisory_link extends CI_Controller {

    private $table_name = "tbl_acgc_link";
    private $page_id = "321";
    private $redirect_path = "adminpanel/current_students/advisory_link";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/current_students/advisory_link_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/current_students/advisory_link');
            } else {
