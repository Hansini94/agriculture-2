...
Class Map_direction extends CI_Controller {
    ...
    private $page_id = "20";
    private $redirect_path = "adminpanel/getting_around/map_direction";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/getting_around/map_direction_view', $data);
    ...
    public function save_map_direction($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_map_direction')) {
                ...
                redirect(base_url() . 'adminpanel/getting_around/map_direction');
            } else {
