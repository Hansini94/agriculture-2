...
Class Faurs_download extends CI_Controller {

    private $table_name = "tbl_faur_download";
    private $page_id = "255";
    private $redirect_path = "adminpanel/research/faurs_download";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/research/faurs_download_view', $data);
    ...
    public function save_download($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/research/faurs_download');
            } else {
