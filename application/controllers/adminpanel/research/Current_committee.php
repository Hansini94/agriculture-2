...
Class Current_committee extends CI_Controller {
    ...
    private $table_name = "tbl_faurs_committee_current";
    private $page_id = "252";
    private $redirect_path = "adminpanel/research/current_committee";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/research/current_committee_view', $data);
    ...
    public function save_committee($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/research/current_committee');
            } else {
