...
Class Non_academic_staff extends CI_Controller {
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->aboutus_model->get_non_academic_staff_list();
	...
	public function edit_non_academic_staff() {
		
        $data['cSaveStatus']= 'E';
        $data['list_data'] = $this->aboutus_model->get_non_academic_staff_list();
		$acaStaffId = $this->uri->segment(5);
		$data['edit_non_academic_staff'] = $this->aboutus_model->get_edit_non_academic_staff($acaStaffId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/aboutus/non_academic_staff_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
