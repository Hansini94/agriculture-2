...
Class Visiting_professors extends CI_Controller {
    ...
    private $page_id = "37";
    private $redirect_path = "adminpanel/international/visiting_professors";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->international_model->get_visiting_professor_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/international/visiting_professor_view', $data);
    ...
    public function save_visiting_professor($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_visiting_professor')) {
                ...
                redirect(base_url() . 'adminpanel/international/visiting_professors');
            } else {
	...
	public function edit_visiting_professor() {
		...
		$data['edit_visiting_professor'] = $this->international_model->get_edit_visiting_professor($profId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/international/visiting_professor_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
