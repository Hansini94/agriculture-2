...
Class Community_engagement extends CI_Controller {

    private $table_name = "tbl_engagement_community";
    private $page_id = "286";
    private $redirect_path = "adminpanel/engagement/community_engagement";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/engagement/community_engagement_view', $data);
    ...
    public function save_engagement($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/engagement/community_engagement');
            } else {
