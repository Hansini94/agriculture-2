...
Class Sec_research_down extends CI_Controller {

    private $table_name = "tbl_sec_research_download";
    private $page_id = "276";
    private $redirect_path = "adminpanel/faculty_staff/sec_research_down";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/faculty_staff/sec_research_down_view', $data);
    ...
    public function save_download($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/faculty_staff/sec_research_down');
            } else {
