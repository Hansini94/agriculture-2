...
Class Sec_general_down extends CI_Controller {

    private $table_name = "tbl_sec_general_download";
    private $page_id = "275";
    private $redirect_path = "adminpanel/faculty_staff/sec_general_down";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/faculty_staff/sec_general_down_view', $data);
    ...
    public function save_download($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/faculty_staff/sec_general_down');
            } else {
