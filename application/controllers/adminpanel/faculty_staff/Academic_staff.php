...
Class Academic_staff extends CI_Controller {
    ...
    private $table_name = "tbl_academic_staff_link";
    private $page_id = "277";
    private $redirect_path = "adminpanel/faculty_staff/academic_staff";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/faculty_staff/academic_staff_view', $data);
    ...
    public function save_department($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/faculty_staff/academic_staff');
            } else {
