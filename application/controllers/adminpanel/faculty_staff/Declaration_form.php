...
Class Declaration_form extends CI_Controller {
    ...
    private $table_name = "tbl_declaration_form";
    private $page_id = "278";
    private $redirect_path = "adminpanel/faculty_staff/declaration_form";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/faculty_staff/declaration_form_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/faculty_staff/declaration_form');
            } else {
