...
Class Previous_committee extends CI_Controller {
    ...
    private $table_name = "tbl_alumni_committee_previous";
    private $page_id = "263";
    private $redirect_path = "adminpanel/alumni/previous_committee";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->alumni_model->get_previous_committee_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/previous_committee_view', $data);
    ...
    public function save_committee($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/alumni/previous_committee');
            } else {
	...
	public function edit() {
		...
		$data['edit_data'] = $this->alumni_model->get_edit_previous_committee($currentId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/previous_committee_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
