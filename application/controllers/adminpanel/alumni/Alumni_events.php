...
Class Alumni_events extends CI_Controller {
    ...
    private $table_name = "tbl_alumni_events";
    private $page_id = "266";
    private $redirect_path = "adminpanel/alumni/alumni_events";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->alumni_model->get_alumni_events_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/alumni_events_view', $data);
    ...
    public function save_events($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/alumni/alumni_events');
            } else {
	...
	public function edit() {
		...
		$data['edit_data'] = $this->alumni_model->get_edit_alumni_events($recId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/alumni_events_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
