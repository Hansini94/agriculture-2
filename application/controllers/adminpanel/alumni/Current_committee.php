...
Class Current_committee extends CI_Controller {

    private $table_name = "tbl_alumni_committee_current";
    private $page_id = "262";
    private $redirect_path = "adminpanel/alumni/current_committee";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->alumni_model->get_current_committee_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/current_committee_view', $data);
    ...
    public function save_committee($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/alumni/current_committee');
            } else {
	...
	public function edit() {
		...
		$data['edit_data'] = $this->alumni_model->get_edit_current_committee($currentId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/alumni/current_committee_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
