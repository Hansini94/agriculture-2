...
Class Student_downloads extends CI_Controller {

    private $table_name = "tbl_student_downloads";
    private $page_id = "155";
    private $redirect_path = "adminpanel/download/student_downloads";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/download/student_downloads_view', $data);
    ...
    public function save_download($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/download/student_downloads');
            } else {
