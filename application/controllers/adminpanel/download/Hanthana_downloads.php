...
Class Hanthana_downloads extends CI_Controller {

    private $table_name = "tbl_facultyd_hanthana";
    private $page_id = "159";
    private $redirect_path = "adminpanel/download/hanthana_downloads";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/download/hanthana_downloads_view', $data);
        $this->load->view('adminpanel/footer_view');
    }

    public function save_hanthana($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/download/hanthana_downloads');
            } else {
