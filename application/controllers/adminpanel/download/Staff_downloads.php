...
Class Staff_downloads extends CI_Controller {

    private $table_name = "tbl_staff_downloads";
    private $page_id = "154";
    private $redirect_path = "adminpanel/download/staff_downloads";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/download/staff_downloads_view', $data);
    ...
    public function save_download($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/download/staff_downloads');
            } else {
