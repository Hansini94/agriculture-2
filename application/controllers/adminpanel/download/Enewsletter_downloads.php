...
Class Enewsletter_downloads extends CI_Controller {

    private $table_name = "tbl_facultyd_enewsletter";
    private $page_id = "157";
    private $redirect_path = "adminpanel/download/enewsletter_downloads";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/download/enewsletter_downloads_view', $data);
        $this->load->view('adminpanel/footer_view');
    }

    public function save_enewsletter($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/download/enewsletter_downloads');
            } else {
