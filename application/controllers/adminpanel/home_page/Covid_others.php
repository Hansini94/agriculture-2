...
Class Covid_others extends CI_Controller {

    private $table_name = "tbl_covid_other";
    private $page_id = "305";
    private $redirect_path = "adminpanel/home_page/covid_others";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/home_page/covid_others_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/covid_others');
            } else {
