...
Class Special_notices extends CI_Controller {

    private $table_name = "tbl_special_notices";
    private $page_id = "150";
    private $redirect_path = "adminpanel/home_page/special_notices";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/home_page/special_notices_view', $data);
    ...
    public function save_notice($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/special_notices');
            } else {
