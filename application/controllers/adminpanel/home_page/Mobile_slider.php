...
Class Mobile_slider extends CI_Controller {

    private $table_name = "tbl_mobile_slider";
    private $page_id = "4";
    private $redirect_path = "adminpanel/home_page/mobile_slider";
    ...
    public function index() {
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->home_model->get_mobile_slider_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/home_page/mobile_slider_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
	
	public function edit_mobile_slider() {
        $data['cSaveStatus']= 'E';
        $data['list_data'] = $this->home_model->get_mobile_slider_list();
		$sliderid = $this->uri->segment(5);
		$data['edit_mobile_slider'] = $this->home_model->get_edit_mobile_slider($sliderid);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/home_page/mobile_slider_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
    ...
    public function save_mobile_slider($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/mobile_slider');
            } else {
