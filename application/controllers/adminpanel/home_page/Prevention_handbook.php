...
Class Prevention_handbook extends CI_Controller {

    private $table_name = "tbl_prevention_handbook";
    private $page_id = "302";
    private $redirect_path = "adminpanel/home_page/prevention_handbook";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/home_page/prevention_handbook_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/prevention_handbook');
            } else {
