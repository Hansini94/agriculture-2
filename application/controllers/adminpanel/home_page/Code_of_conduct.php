...
Class Code_of_conduct extends CI_Controller {
    ...
    private $page_id = "78";
    private $redirect_path = "adminpanel/home_page/code_of_conduct";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/home_page/code_of_conduct_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/code_of_conduct');
            } else {
