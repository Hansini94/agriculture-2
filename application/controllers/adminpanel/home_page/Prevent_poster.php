...
Class Prevent_poster extends CI_Controller {

    private $table_name = "tbl_prevent_poster";
    private $page_id = "303";
    private $redirect_path = "adminpanel/home_page/prevent_poster";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/home_page/prevent_poster_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/prevent_poster');
            } else {
