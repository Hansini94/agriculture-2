...
Class File_upload extends CI_Controller {
    ...
    private $table_name = "tbl_file_upload";
    private $page_id = "152";
    private $redirect_path = "adminpanel/home_page/file_upload";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/home_page/file_upload_view', $data);
    ...
    public function save_file($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/home_page/file_upload');
            } else {
