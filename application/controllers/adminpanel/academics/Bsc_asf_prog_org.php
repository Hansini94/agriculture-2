...
Class Bsc_asf_prog_org extends CI_Controller {

    private $table_name = "tbl_bsc_prog_org";
    private $page_id = "100";
    private $redirect_path = "adminpanel/academics/bsc_asf_prog_org";
    ...
    public function index() {	
        ...
        $data['prog_org_data'] = $this->academic_model->get_bsc_asf_prog_org_data();
        // var_dump($data['undergraduate_data']);exit();
		//echo 'ff'; exit();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/academics/bsc_asf_prog_org_view', $data);
    ...
    public function save_bsc_prog_org($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_bsc_prog_org')) {
                ...
                redirect(base_url() . 'adminpanel/academics/bsc_asf_prog_org');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/academics/bsc_asf_prog_org/update_details/".$imageID);
            } else {
