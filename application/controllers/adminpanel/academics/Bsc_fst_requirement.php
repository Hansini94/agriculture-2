...
Class Bsc_fst_requirement extends CI_Controller {

    private $table_name = "tbl_bsc_requirement";
    private $page_id = "105";
    private $redirect_path = "adminpanel/academics/bsc_fst_requirement";
    ...
    public function index() {	
        ...
        $data['requirement_data'] = $this->academic_model->get_bsc_fst_requirement_data();
        // var_dump($data['undergraduate_data']);exit();
		//echo 'ff'; exit();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/academics/bsc_fst_requirement_view', $data);
    ...
    public function save_bsc_requirement($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data('tbl_bsc_requirement')) {
                ...
                redirect(base_url() . 'adminpanel/academics/bsc_fst_requirement');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/academics/bsc_fst_requirement/update_details/".$imageID);
            } else {
