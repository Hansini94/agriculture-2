...
Class Bsc_fst_scholarship extends CI_Controller {

    private $table_name = "tbl_bsc_fst_scholarship";
    private $page_id = "112";
    private $redirect_path = "adminpanel/academics/bsc_fst_scholarship";
    ...
    public function index() {
        ...
        $data['cSaveStatus']= 'A';
        $data['list_data'] = $this->academic_model->get_fst_scholarship_list();
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/academics/bsc_fst_scholarship_view', $data);
    ...
    public function save_bsc_scholarship($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/academics/bsc_fst_scholarship');
            } else {
	...
	public function edit_bsc_scholarship() {
		...
		$data['edit_scholarship'] = $this->academic_model->get_edit_fst_scholarship($schlId);
        $this->load->view('adminpanel/header_view');
        $this->load->view('adminpanel/academics/bsc_fst_scholarship_view', $data);
        $this->load->view('adminpanel/footer_view');
    }
