...
Class Search extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->model('frontend_model/search_model');
        ...
        //pagination customization using bootstrap styles
         ...
         $config["total_rows"] = count($this->search_model->get_search_result(0,0));
        ...
        $this->load->view('frontendview/search_result_view',$data);
