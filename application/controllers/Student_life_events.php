...
Class Student_life_events extends CI_Controller {
    ...
    public function index() {
        ...
        $config["total_rows"] = $this->student_life_model->get_count_events();
        $config["per_page"] = 6;
        ...
        $data['events'] = $this->student_life_model->get_events_details();
        $data['all'] = $this->student_life_model->get_events_list($config["per_page"], $page);
    ...
    public function events_detail($name) {
        ...
        $data['data'] = $this->student_life_model->get_events_data($newString);
        $data['events'] = $this->student_life_model->get_events_details();
        $data_header['quick_links'] = $this->home_page_model->get_quick_list();
        // var_dump($data);exit();
