...
// Student Alumni
	...
	{
        return $this->db->count_all("tbl_gewiu_student_alumni");
    }

    public function get_alumni_list($limit, $start) {
        $this->db->from('tbl_gewiu_student_alumni');
    ...
    public function get_module_name($id) {
     ...
     public function get_module_series_id($id) {
        $this->db->from('tbl_gewiu_module_students');
