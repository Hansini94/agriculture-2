...
if ($cSaveStatus == "E") {
    ...
    $tSubContent = $edit_data[0]->tSubContent;
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            <h2>Engagements Overview</h2>
                        </div>
                        <div class="col-md-3 col-sm-12 col-xs-12">
                        <ul class="nav navbar-right ">
                            <!-- <li><a class="collapse-link" href="<?php echo base_url('adminpanel/engagements/overview'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add Composition</span>&nbsp;</a></li> -->
                        </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content" <?php
                                            ...
                                            ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/engagements/overview/save_data'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">                           
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        ...
                                        <a href="<?php echo base_url().'adminpanel/engagements/overview/remove_image/'.$id.'/fImg/'.$fImg;?>">Remove image</a> 
                                    </div>
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/engagements/overview'); ?>';">Cancel</button>
