...
Class News extends CI_Controller {
    ...
    public function index() {
        ...
        $config = array();
        $config["base_url"] = base_url() . "Training-Workshops";
        ...
        $data_header['meta'] = 13;
        $data['all'] = $this->news_model->get_news_list($config["per_page"], $page+2);
        $data_header['quick_links'] = $this->home_page_model->get_quick_list();

        $this->load->view('frontendview/inner_header_view',$data_header);
        $this->load->view('frontendview/others/news_view',$data);
    ...
    public function news_detail() {
        ...
        $this->load->view('frontendview/inner_header_view',$data_header);
        $this->load->view('frontendview/others/news_detail_view',$data);
        $this->load->view('frontendview/footer_view', $data_header);
