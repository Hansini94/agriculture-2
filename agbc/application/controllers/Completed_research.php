...
Class Completed_research extends CI_Controller {
    ...
    public function index() {
        ...
        $config = array();
        $config["base_url"] = base_url() . "Completed-Research";
        ...
        $data_header['meta'] = 12;
        $data['all'] = $this->research_model->get_student_list($config["per_page"], $page+2);
        $data_header['quick_links'] = $this->home_page_model->get_quick_list();

        $this->load->view('frontendview/inner_header_view',$data_header);
        $this->load->view('frontendview/research/completed_research_view',$data);
        $this->load->view('frontendview/footer_view', $data_header);
       
    }	
    
    public function completed_research_detail() {
        ...
        $this->load->view('frontendview/inner_header_view',$data_header);
        $this->load->view('frontendview/research/completed_research_detail_view',$data);
        $this->load->view('frontendview/footer_view', $data_header);
