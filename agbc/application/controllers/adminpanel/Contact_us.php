...
Class Contact_us extends CI_Controller {
    ...
    private $table_name = "tbl_biotech_contact_us";
    private $page_id = "25";
    ...
    public function save_contact_us($data = '') {
        ...
        if ($save_status === 'E') {
            if ($this->common_model->update_saved_data('tbl_biotech_contact_us')) {
            ...
            if ($this->common_model->save_data('tbl_biotech_contact_us')) {
                //$tDes = "saved data has been updated";
                //$this->common_model->add_log($tDes);
                $this->session->set_flashdata('message_saved', 'Saved successfully.');
                redirect(base_url() . 'adminpanel/contact_us');
