          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url("Completed-Research"); ?>">Completed Research and Collaborations</a></li>
    ...
    <div class="row">
       ...
       <?php
        ...
        <div class="row m-auto">
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
          <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $detail->vPerson; ?></small></p>
          ...
          <div class="row">
            ...
            <!-- =========== -->
             ...
             <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
              <div class="gray_text_div dean_des_div">              
                <h1 class="sub_heading mb-1">Funding Agency</h1>
                  <p class="fst-italic mb-1">
                  <?php echo $detail->vFundingAgency; ?>
                  </p>
              </div>
            </div>
            ...
            <!-- =========== -->
             ...
             <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
              <div class="gray_text_div dean_des_div">              
                <h1 class="sub_heading mb-1">Leader</h1>
                  <p class="fst-italic mb-1">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
              <div class="gray_text_div dean_des_div">              
                <h1 class="sub_heading mb-1">Investigators</h1>
                  <p class="fst-italic mb-1">
  ...
  <!-- publications section -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h1 class="heading">Other Completed Researches and Collaborations</h1>
                 ...
                 <div class="news_div">
                  ...
                  <div class="row">
                     ...
                     <a href='<?php  
                                    ...
                                    echo base_url('completed-research/completed-research-detail/'. $all_data->id . '/' .$name);  ?>'>
