          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url("Ongoing-Research"); ?>">Ongoing Research</a></li>
  ...
  <!-- publications section -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h1 class="heading">Other Ongoing Researches</h1>
                 ...
                 <div class="news_div">
                  ...
                  <div class="row">
                     ...
                     <a href='<?php  
                                    ...
                                    echo base_url('ongoing-research/ongoing-research-detail/'. $all_data->id . '/' .$name);  ?>'>
