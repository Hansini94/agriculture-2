          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
            ...
            <li class="nav-item active">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Labs-Equipment'); ?>">Labs and Equipment</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Service-Charges'); ?>">Service and Charges</a></li>
                <!--<li><a class="dropdown-item" href="<?php echo base_url('Resources'); ?>">Resources</a></li>-->
              </ul>
            </li>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Postgraduate-Research-Students'); ?>">Postgraduate Research Students</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Undergraduate-Research-Students'); ?>">Undergraduate Research Students/Interns</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Ongoing-Research'); ?>">Ongoing Research</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Completed-Research'); ?>">Completed Research and Collaborations</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Training-Workshops'); ?>">Training and Workshops</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('News-Events'); ?>">News and Events</a></li>
              </ul>
            </li>
