          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Postgraduate Research Students</b></li>
              </ol>
            </nav>
            </div>
          </div>
          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row ms-auto">
              ...
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-8 col-12">
                ...
                ?>
                    <a href="<?php echo base_url('module/load_detail/'.$mod->id) ?>">
                        <button class="nav-link <?php 
                        if($name->vName === $mod->vName){echo 'active';}else{echo '';}
                        ?>">
                            <?php echo $mod->vName; ?>
                        </button>
                    </a>  
                ...
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                    <h1 class="heading mb-3"><?php echo $name->vName; ?></h1>
                    <?php    
                        if(isset($series)){    
                                $i=0;
                        ...
                        ?>
                    <div class="row">
                        <h1 class="sub_heading mb-3"><?php echo $series_data->vSeries; ?></h1>
                        <?php    
                        if(isset($students)){    
                                $i=0;
                                foreach($students as $data )
                                {      
                                    if($series_data->vSeries === $data->vSeries) {                                
                        ?> 
