    ...
    <div class="container-fluid" style="background-color: #efd2d1;">
      ...
      <div class="container">
        ...
        <div class="row"> 
          ...
          <h1 class="heading mb-3">Training & Workshops</h1>
            ...
            <div class="row">
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                ...
                <a class='animated-arrow' href='<?php 
                                                    ...
                                                    echo base_url('training-workshops/training-detail/'. $news->id . '/' .$name);
                                                ?>'>
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <a href='<?php $heading = $featured_news[0]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[0]->id . '/' .$name); ?>'>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
      ...
      <div class="news_div">
        ...
        <a href='<?php $heading = $featured_news[1]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[1]->id . '/' .$name); ?>'>
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <a href='<?php  $heading = $featured_news[2]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[2]->id . '/' .$name); ?>'>
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <a href='<?php  $heading = $featured_news[3]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[3]->id . '/' .$name); ?>'>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
      ...
      <div class="news_div">
        ...
        <a href='<?php  $heading = $featured_news[4]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[4]->id . '/' .$name); ?>'>
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            ...
            <a href='<?php  $heading = $featured_news[5]->vName; 
                                                    $name = str_replace(' ', '-', $heading); 
                                                    $name = preg_replace('/[^A-Za-z0-9\-]/', '', $name);
                                                    echo base_url('training-workshops/training-detail/'. $featured_news[5]->id . '/' .$name); ?>'>
