                        ...
                        <form id="Edit_hotel" name="Edit_hotel" action="<?php echo base_url('adminpanel/home_page/main_slider/save_main_slider'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <input type="hidden" id="iIsDelete" name="iIsDelete" value="0">
                                    ...
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td style="text-align:center;">
                                                <?php if($no_count != 1){?>
                                                <a  href="<?php echo base_url() . "adminpanel/home_page/main_slider/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                                    <i class="<?php echo $clicon; ?>"></i>
                                                </a>
                                                <?php } ?>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;">
                                                <?php if($no_count != 1){?>
                                                <a  href="<?php echo base_url() . "adminpanel/home_page/main_slider/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
