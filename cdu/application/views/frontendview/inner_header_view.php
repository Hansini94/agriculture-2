          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo base_url('Outreach'); ?>">Outreach</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo base_url('Foreign'); ?>">Foreign</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Training'); ?>">Training</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Consultancies'); ?>">Consultancies</a></li>
              </ul>
            </li>
