        ...
        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12">
          ...
          <div class="row">
              ...
              <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 footer_link_col">
                ...
                <a href="<?php echo base_url("Foreign"); ?>"><p>Foreign</p></a>      
                <a href="<?php echo base_url("News"); ?>"><p>News</p></a>
                               
              </div>

              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 footer_link_col">
                <a href="<?php echo base_url("Projects"); ?>"><p>Projects</p></a>
                <a href="<?php echo base_url("Outreach"); ?>"><p>Outreach</p></a>
                <a href="<?php echo base_url("Training"); ?>"><p>Training</p></a>
                <a href="<?php echo base_url("Consultancies"); ?>"><p>Consultancies</p></a>   
