...
// Student Alumni
	...
	{
        return $this->db->count_all("tbl_comdev_foreign");
    }

    public function get_alumni_list($limit, $start) {
        $this->db->from('tbl_comdev_foreign');
    ...
    public function get_module_name($id) {
     ...
     public function get_module_series_id($id) {
        $this->db->from('tbl_comdev_local_students');
...
//Economic and Applied Entomology
    ...
    //     $this->db->from('tbl_comdev_eae_series_students');
    //     $this->db->group_by('vSeries');
    //     $this->db->order_by('id', 'desc');
    //     $result = $this->db->get();
    //     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_comdev_gip_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_comdev_mbb_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_comdev_ppm_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
