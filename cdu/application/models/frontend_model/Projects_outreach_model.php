...
//ongoing projects
    ...
    //     $this->db->from('tbl_comdev_core_program');
    //     $this->db->where('id', 1);
    //     $result = $this->db->get();
    ...
    public function get_ongoing_tab_data() {
        $this->db->from('tbl_comdev_ongoing_projects');
    ...
    public function get_module_tab_data() {
        $this->db->from('tbl_comdev_completed_projects');
        $this->db->where('cEnable', 'Y');
        $this->db->order_by('id', 'asc');
        $result = $this->db->get();
        //echo $this->db->last_query();  exit();  
    ...
    public function get_postgraduate_data() {
        $this->db->from('tbl_comdev_outreach');
        $this->db->where('cEnable', 'Y');
