...
Class Featured_publications extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_feautured_publications";
    private $page_id = "20";
    ...
    public function __construct() {
        ...
        set_title("Featured Publications");
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/others/featured_publications_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/others/featured_publications');
            } else {
