...
Class User_type extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_user_type";
    ...
    public function save_user_type() {
        ...
        if ($save_status === 'E')
            ...
            $this->form_validation->set_rules('vAccTypeName', 'account type', 'required|trim|is_unique[tbl_experimental_user_type.vAccTypeName]|max_length[50]');
