...
Class Training extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_research_projects";
    private $page_id = "20";
    ...
    public function __construct() {
        ...
        set_title("Training and Consultancies");
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/training_consultancies/training_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/training_consultancies/training');
            } else {
