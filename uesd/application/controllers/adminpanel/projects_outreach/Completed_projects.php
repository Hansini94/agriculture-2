...
Class Completed_projects extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_advanced_modules";
    private $page_id = "7";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/projects_outreach/completed_projects_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/projects_outreach/completed_projects');
            } else {
