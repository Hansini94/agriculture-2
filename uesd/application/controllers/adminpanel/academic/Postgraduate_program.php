...
Class Postgraduate_program extends CI_Controller {

    private $table_name = "tbl_experimental_postgraduate_program";
    private $page_id = "8";
    private $redirect_path = "adminpanel/academic/postgraduate_program";
    ...
    public function __construct() {
        ...
        set_title("Postgraduate Program");
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/academic/postgraduate_program_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/academic/postgraduate_program');
            } else {
