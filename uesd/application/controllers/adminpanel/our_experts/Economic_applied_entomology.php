...
Class Economic_applied_entomology extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_eae_series_students";
    private $page_id = "14";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/student/economic_applied_entomology_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/economic_applied_entomology');
            } else {
