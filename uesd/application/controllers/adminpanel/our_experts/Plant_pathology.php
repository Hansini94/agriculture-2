...
Class Plant_pathology extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_ppm_series_students";
    private $page_id = "17";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/student/plant_pathology_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/plant_pathology');
            } else {
