...
Class Molecular_biology extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_mbb_series_students";
    private $page_id = "16";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/student/molecular_biology_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/molecular_biology');
            } else {
