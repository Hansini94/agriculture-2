...
Class Genetic_improvements extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_gip_series_students";
    private $page_id = "15";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/student/genetic_improvements_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/student/genetic_improvements');
            } else {
