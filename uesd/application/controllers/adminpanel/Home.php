...
Class Home extends CI_Controller {
    ...
    private $table_name = "tbl_experimental_home";
    private $page_id = "2";
    ...
    public function save_home($data = '') {
        ...
        if ($save_status === 'E') {
            if ($this->common_model->update_saved_data('tbl_experimental_home')) {
            ...
            if ($this->common_model->save_data('tbl_experimental_home')) {
                //$tDes = "saved data has been updated";
                //$this->common_model->add_log($tDes);
                $this->session->set_flashdata('message_saved', 'Saved successfully.');
                redirect(base_url() . 'adminpanel/home');
