                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="Edit_hotel" name="Edit_hotel"
                            action="<?php echo base_url('adminpanel/staff/management/save_caption'); ?>" method="post"
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right"
                                        onclick="document.location.href = '<?php echo base_url('adminpanel/staff/management/'); ?>';">Cancel</button>
