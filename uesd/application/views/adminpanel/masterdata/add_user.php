                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url('adminpanel/master/user/save_user'); ?>" method="post" novalidate>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" id="vContactNo" name="vContactNo" required class="form-control col-md-7 col-xs-12" value="<?php echo set_value('vContactNo', $vContactNo); ?>">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        ...
                                        <input type="hidden" id="tbl_experimental_name" name="tbl_experimental_name" value="tbl_experimental_backend_user">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <?php /* ?><div class="form-group">
                                  <label class="control-label col-md-4 col-sm-3 col-xs-12">Password<span class="required">*</span>
                                  </label>
                                  <div class="col-md-8 col-sm-6 col-xs-12">
                                  ...
                                  <label class="control-label col-md-4 col-sm-3 col-xs-12">Confirm Password<span class="required">*</span>
                                  </label>
                                  <div class="col-md-8 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-6 col-xs-12 ">
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/master/user/add_user'); ?>';">Cancel</button>
                            ...
                            <tbody>
                                ...
                                foreach ($list_data as $rowlist) {
                                    ...
                                    <tr class="<?php echo $oddeven; ?>">
                                        ...
                                        <td class=" "><a onclick="return confirm('Are you sure you want to change this?');" href="<?php echo base_url() . "adminpanel/master/user/change_status/$recordid" ?>">
                                                <i class="<?php echo $clicon; ?>"></i></a>

                                        </td>
                                        <td class="a-right a-right "><a onclick="return confirm('Are you sure you want to delete this?');" href="<?php echo base_url() . "adminpanel/master/user/delete_record/$recordid" ?>">
