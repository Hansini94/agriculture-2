          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Outreach</b></li>
              </ol>
            </nav>
            </div>
          </div>
        ...
        <div class="row ms-auto">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-left: 0px !important;">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><p>Agricultural Biology</p></button>
            </li>
            <?php }elseif(isset($post_graduate[1])){?>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><p>Plant Protection</p></button>
            </li>
            <?php } ?>
          </ul>
