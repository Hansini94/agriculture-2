        ...
        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12">
          ...
          <div class="row">
              ...
              <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 footer_link_col">
                ...
                <a href="<?php echo base_url("About"); ?>"><p>About</p></a>
                <a href="<?php echo base_url("Training-Research"); ?>"><p>Training and Research</p></a>
                <a href="<?php echo base_url("Facilities"); ?>"><p>Facilities</p></a>                                
              </div>

              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 footer_link_col">
                <a href="<?php echo base_url("Production-Unit"); ?>"><p>Production Units</p></a>
                <a href="<?php echo base_url("Biodiversity-Plantation"); ?>"><p>Biodiversity & Plantation Fields</p></a>
                <a href="<?php echo base_url("Contact-Us"); ?>"><p>Contact Us</p></a>
              </div>
