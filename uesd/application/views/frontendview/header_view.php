...
<html lang="en">
  ...
  <?php
    ...
    <title>University Experimental Station - Dodangolla</title>
  ...
  <!--===================header====================-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top desktop_menu d-none d-lg-block" style="position: absolute; background-color: #ffffff !important;">
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive"  aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse flex-grow-1 text-right" id="navbarResponsive">
          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="<?php echo base_url("Training-Research"); ?>" >
              Training and Research
              </a>
            </li>

            <li class="nav-item ">
              <a class="nav-link" href="<?php echo base_url("Facilities"); ?>" >
              Facilities
              </a>
            </li>

            <li class="nav-item ">
              <a class="nav-link" href="<?php echo base_url("Production-Unit"); ?>" >
              Production Units
              </a>
            </li>

            <li class="nav-item ">
              <a class="nav-link" href="<?php echo base_url("Biodiversity-Plantation"); ?>" >
              Biodiversity & Plantation Fields
              </a>
            </li>
    ...
    <header>
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" style="background-image: url('<?php echo base_url("front_img/bg1.jpg"); ?>')">
          ...
          <div class="carousel-item" style="background-image: url('<?php echo base_url("front_img/bg2.jpg"); ?>')">
            <div class="container carousel-caption">
              <div class="row">
                <div class="col-xxl-6 offset-xxl-6 col-xl-6 offset-xl-6 col-lg-6 offset-lg-6 col-md-6 offset-md-6 col-sm-12 carousel_caption_col angled-bottom-left">
          ...
          <div class="carousel-item" style="background-image: url('<?php echo base_url("front_img/bg3.jpg"); ?>')">
            <div class="container carousel-caption">
              <div class="row">
                <div class="col-xxl-6 offset-xxl-6 col-xl-6 offset-xl-6 col-lg-6 offset-lg-6 col-md-6 offset-md-6 col-sm-12 carousel_caption_col angled-bottom-left">
                  <!-- <h5>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h5>
