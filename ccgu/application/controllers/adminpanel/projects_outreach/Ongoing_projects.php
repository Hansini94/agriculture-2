...
Class Ongoing_projects extends CI_Controller {
    ...
    private $table_name = "tbl_career_ongoing_projects";
    private $page_id = "6";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/projects_outreach/ongoing_projects_view', $data);
    ...
    public function save_series($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/projects_outreach/ongoing_projects');
            } else {
