                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <h2>Management Staff Caption</h2>
                        </div>
                    ...
                    <div class="x_content">
                        ...
                        <form id="Edit_hotel" name="Edit_hotel"
                            action="<?php echo base_url('adminpanel/staff/management_support/save_caption'); ?>" method="post"
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-default pull-right"
                                        onclick="document.location.href = '<?php echo base_url('adminpanel/staff/management_support/'); ?>';">Cancel</button>
