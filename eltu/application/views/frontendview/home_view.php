<div class="container top_box_con">
      ...
      <div class="news_div">
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
            <a href='<?php $heading = $featured_news[0]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
      ...
      <div class="news_div">
        <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
        <a href='<?php $heading = $featured_news[1]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
      <div class="news_div">
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
            <a href='<?php $heading = $featured_news[2]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
      <div class="news_div">
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
            <a href='<?php $heading = $featured_news[3]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-4 col-12">
      ...
      <div class="news_div">
        <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
        <a href='<?php $heading = $featured_news[4]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
      <div class="news_div">
        ...
        <div class="row">
          ...
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            <p style="margin-top: 0px; margin-bottom: 0px; color: #2c4f93;"><small><?php echo $date; ?></small></p>
            <a href='<?php $heading = $featured_news[5]->vName; $name = str_replace(' ', '_', $heading); echo base_url('news/news_detail/'.$name) ?>'>
