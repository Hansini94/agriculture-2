          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Ongoing-Course'); ?>">On-Going Course In English</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Intensive-Course'); ?>">Intensive Course In English</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Services'); ?>">Services</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Facilities'); ?>">Facilities</a></li>
              </ul>
            </li>
