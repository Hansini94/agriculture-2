          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url("Facilities"); ?>">Facilities</a></li>
  ...
  <!-- publications section -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h1 class="heading">Other Facilities</h1>
...
echo base_url('facilities/facilities-detail/'. $all_data->id . '/' .$name); ?>'>
