...
Class Previous_year extends CI_Controller {
    ...
    public function index() {
        ...
        $config = array();
        $config["base_url"] = base_url() . "Previous-Years";
        ...
        $this->load->view('frontendview/research/previous_year_view',$data);
        $this->load->view('frontendview/footer_view', $data_header);
       
    }	
    
    public function previous_year_detail() {
        ...
        $this->load->view('frontendview/inner_header_view',$data_header);
        $this->load->view('frontendview/research/previous_year_detail_view',$data);
        $this->load->view('frontendview/footer_view', $data_header);
