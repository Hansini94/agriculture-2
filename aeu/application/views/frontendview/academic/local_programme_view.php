        ...
        <div class="row ms-auto">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-left: 0px !important;">
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('Local'); ?>"><button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><p>Program</p></button></a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('Local-Description'); ?>"><button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><p>Description</p></button></a>
            </li>
          </ul>
