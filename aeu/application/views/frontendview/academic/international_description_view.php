        ...
        <div class="inner_page_top_img" style="background: url(<?php echo base_url("assets/frontend/"); ?>images/shading.png) left center no-repeat, url(<?php $pageBanner = get_innerpage_banner($this->uri->segment(1)); if($pageBanner !== false){ foreach($pageBanner as $banner){if($this->uri->segment(1) == $banner->vPageRoute){echo base_url().'front_img/'.$banner->fImage;}}}else{echo base_url().'/assets/frontend/images/slider01.jpg';}  ?>) center top repeat;">
          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              <h1 class="heading" data-aos="fade-up">Training Programs</h1>
              <nav aria-label="breadcrumb" data-aos="fade-down">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url("/"); ?>">Home</a></li>
                <li class="breadcrumb-item"><a href="<?php echo base_url("International"); ?>">International</a></li>
                <li class="breadcrumb-item active" aria-current="page"><b>Description</b></li>
              </ol>
            </nav>
            </div>
          </div>
        ...
        <div class="row ms-auto">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-left: 0px !important;">
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('International'); ?>"><button class="nav-link " id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><p>Program</p></button></a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('Description'); ?>"><button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><p>Description</p></button></a>
            </li>
          </ul>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">    
                        <div class="row">
                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-8 col-12">                
                                ...
                                ?>
                                <a href="<?php echo base_url('advanced_module/load_detail/'.$module->id) ?>">
                            ...
                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                                <div class="row ms-auto">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-4 p-5" style="padding-top: 0px !important; padding-bottom: 0px !important;">
                                        <div class="row">
                                            <div class="bgimg_div">
                                                <img src="<?php echo base_url('front_img/').$detail->fImage1; ?>" alt="" class="dd-block w-100">
                                            </div> 
                                        </div>
                                    </div>
                                    <?php }if($detail->fImage2 != NULL){ ?>
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-4 p-5" style="padding-top: 0px !important; padding-bottom: 0px !important;">
                                        <div class="row">
                                            <div class="bgimg_div">
                                                <img src="<?php echo base_url('front_img/').$detail->fImage2; ?>" alt="" class="dd-block w-100">
                                            </div>  
                                        </div>
                                    </div>
                                    <?php } ?>
                            ...
                            else if(isset($advanced_module[0]->fImage1)){
                             ?>
                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                                <div class="row ms-auto">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-4 p-5" style="padding-top: 0px !important; padding-bottom: 0px !important;">
                                        <div class="row">
                                            <div class="bgimg_div">
                                                <img src="<?php echo base_url('front_img/').$advanced_module[0]->fImage1; ?>" alt="" class="dd-block w-100">
                                            </div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-4 p-5" style="padding-top: 0px !important; padding-bottom: 0px !important;">
                                        <div class="row">
                                            <div class="bgimg_div">
                                                <img src="<?php echo base_url('front_img/').$advanced_module[0]->fImage2; ?>" alt="" class="dd-block w-100">
                                            </div>  
                                        </div>
                                    </div>
                                </div>
