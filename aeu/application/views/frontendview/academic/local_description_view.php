          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url("Local"); ?>">Local</a></li>
        ...
        <div class="row ms-auto">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-left: 0px !important;">
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('Local'); ?>"><button class="nav-link " id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><p>Program</p></button></a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="<?php echo base_url('Local-Description'); ?>"><button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><p>Description</p></button></a>
            </li>
          </ul>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">    
                        <div class="row">
                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-8 col-12">                
                                ...
                                ?>
                                <a href="<?php echo base_url('local_description/load_detail/'.$module->id) ?>">
