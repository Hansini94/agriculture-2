        ...
        <div class="collapse navbar-collapse flex-grow-1 text-right" id="navbarResponsive">
          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
            ...
            <li class="nav-item active">
             ...
             <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('International'); ?>">International</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Local'); ?>">Local</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Current-Year'); ?>">Current Year</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Previous-Years'); ?>">Prevoius Years</a></li>
              </ul>
            </li>
        ...
        <div class="collapse navbar-collapse flex-grow-1 text-right" id="navbarResponsive">
          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('Current-Year'); ?>">Current Year</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('Previous-Years'); ?>">Previous Years</a></li>
              </ul>
            </li>
