...
// Student Alumni
	...
	{
        return $this->db->count_all("tbl_food_student_alumni");
    }

    public function get_alumni_list($limit, $start) {
        $this->db->from('tbl_food_student_alumni');
    ...
    public function get_module() {
     ...
     public function get_module_name_id() {
        ...
        // return $this->db->get_where('tbl_food_engagement_research', ['id' => $id])->row();
    }
    ...
    public function get_module_name($id) {
     ...
     public function get_module_series_id($id) {
        $this->db->from('tbl_food_module_students');
...
//Economic and Applied Entomology
    ...
    //     $this->db->from('tbl_food_eae_series_students');
    //     $this->db->group_by('vSeries');
    //     $this->db->order_by('id', 'desc');
    //     $result = $this->db->get();
    //     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_food_gip_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_food_mbb_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_food_ppm_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
