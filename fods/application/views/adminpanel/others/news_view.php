        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                    
                    <div class="x_title">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <ul class="nav navbar-right">
                                ...
                                <li><a class="collapse-link" href="<?php echo base_url('adminpanel/others/news'); ?>" style="text-align:right;cursor:pointer;"><span class="btn btn-dark"  style="color:#FFF;">Add News</span>&nbsp;</a></li>
                                <?php } else { ?>
                    ...
                    ?>>
                        <br />
                        <form id="edit_data" name="edit_data" action="<?php echo base_url('adminpanel/others/news/save_news'); ?>" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <input type="hidden" id="cFeatured" name="cFeatured" value="<?php echo $cFeatured ?>">
                                    <input type="hidden" id="cSlider" name="cSlider" value="<?php echo $cSlider ?>">
                                    <input type="hidden" id="cSaveStatus" name="cSaveStatus" value="<?php echo $cSaveStatus; ?>">
                                    <button type="button" class="btn btn-default pull-right" onclick="document.location.href = '<?php echo base_url('adminpanel/others/news'); ?>';">Cancel</button>
                                ...
                                if (count($list_data) != 0) {
                                    foreach ($list_data as $rowlist) {
                                        ...
                                        <tr class="<?php echo $oddeven; ?>">
                                            ...
                                            <td><?php echo $rowlist->dNewsdate;?></td>                                            
                                            <td><?php echo $rowlist->iOrder;?></td> 
                                            <td style="text-align:center;"><a href="<?php echo base_url() . "adminpanel/others/news/edit/$recordid" ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </td>
                                            <td style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/others/news/change_status/status/$recordid" ?>" onclick="return confirm('Are you sure?')">
                                            ...
                                            <td style="text-align:center; vertical-align: middle;">
                                                ...
                                                <script type="text/javascript">                                                                                 
                                                    $('#slider_<?php echo $recordid; ?>').on('change', function (e) {
                                                        if ($(this).prop('checked')) {
                                                            window.location.href = '<?php echo base_url("adminpanel/others/news/active_record/$recordid/cSlider"); ?>';
                                                        } else {
                                                            window.location.href = '<?php echo base_url("adminpanel/others/news/deactive_record/$recordid/cSlider"); ?>';
                                                        }
                                                    });
                                            ...
                                            <td style="text-align:center; vertical-align: middle;">
                                                ...
                                                <script type="text/javascript">                                                                                 
                                                    $('#featured_<?php echo $recordid; ?>').on('change', function (e) {
                                                        if ($(this).prop('checked')) {
                                                            window.location.href = '<?php echo base_url("adminpanel/others/news/active_record/$recordid/cFeatured"); ?>';
                                                        } else {
                                                            window.location.href = '<?php echo base_url("adminpanel/others/news/deactive_record/$recordid/cFeatured"); ?>';
                                                        }
                                                    });

                                                </script>
                                            </td>
                                            <td class="a-right a-right" style="text-align:center;"><a  href="<?php echo base_url() . "adminpanel/others/news/delete_record/delete/$recordid" ?>" onclick="return confirm('Are you sure?')">
