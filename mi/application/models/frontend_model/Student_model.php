...
// Student Alumni
	...
	{
        return $this->db->count_all("tbl_mi_student_alumni");
    }

    public function get_alumni_list($limit, $start) {
        $this->db->from('tbl_mi_student_alumni');
    ...
    public function get_module() {
     ...
     public function get_module_name_id() {
        ...
        // return $this->db->get_where('tbl_mi_engagement_research', ['id' => $id])->row();
    }
    ...
    public function get_module_name($id) {
     ...
     public function get_module_series_id($id) {
        $this->db->from('tbl_mi_module_students');
...
//Economic and Applied Entomology
    ...
    //     $this->db->from('tbl_mi_eae_series_students');
    //     $this->db->group_by('vSeries');
    //     $this->db->order_by('id', 'desc');
    //     $result = $this->db->get();
    //     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_mi_gip_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_mi_mbb_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
...
//     $this->db->from('tbl_mi_ppm_series_students');
//     $this->db->group_by('vSeries');
//     $this->db->order_by('id', 'desc');
//     $result = $this->db->get();
//     //echo $this->db->last_query();  exit();  
