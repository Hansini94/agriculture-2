...
Class User extends CI_Controller {
    ...
    private $table_name = "tbl_iqac_backend_user";
    private $page_id = "31";
    ...
    public function add_user($data = '') {
        ...
        $sql_user_type = "SELECT tbl_iqac_user_type.vAccTypeName,tbl_iqac_user_type.id FROM tbl_iqac_user_type $where ORDER BY tbl_iqac_user_type.vAccTypeName ASC";
    ...
    public function save_user() {
        ...
        if ($this->common_library->check_privilege('p_edit')) {
            if ($save_status === 'E')
                ...
                $this->form_validation->set_rules('vUserName', 'user name', 'required|trim|is_unique[tbl_iqac_backend_user.vUserName]|xss_clean');
