...
Class Management_support extends CI_Controller {
    ...
    private $table_name = "tbl_iqac_management_support";
    private $table_name1 = "tbl_iqac_management_support_caption";
    private $table_name2 = "tbl_iqac_management_support_category";
    private $page_id = "11";
