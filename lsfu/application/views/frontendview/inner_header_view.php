...
<html lang="en">
  <head>
    ...
    <title>Livestock Farm, Udaperadeniya</title>
...
<?php 
        ...
        <div class="collapse navbar-collapse flex-grow-1 text-right" id="navbarResponsive">
          ...
          <ul class="navbar-nav ms-auto second_nav_bar">
            ...
            <!--<li class="nav-item">-->
            <!--  <a class="nav-link" href="<?php echo base_url('Units'); ?>">Units</a>-->
            <!--</li>-->
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php echo base_url('amimal-units'); ?>">Animal Units</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('sales-centres'); ?>">Sales Centres</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url('processing-units'); ?>">Processing Units</a></li>
              </ul>
            </li>
