        ...
        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-12 col-sm-12">
          ...
          <div class="row">
            ...
            <div class="row hidden_item">
              ...
              <div class="clearfix"></div><br>
              <h1 class="sub_heading">Vision</h1>
                
              <p data-aos="fade-up">To be a leading teaching Livestock Farm in region and produce quality breeding material,livestock & agricultural products to enhance the Socio-Economic standards of our people.</p>
            
            <div class="clearfix"></div><br>
            
            <h1 class="sub_heading">Mission</h1>
                
              <p data-aos="fade-up">Developing the livestock sector being the main objective of producing trainee graduates to the society and providing knowledge of animal husbandry who are interested in Livestock sector.</p>
                <!-- 
              <p data-aos="fade-up">
