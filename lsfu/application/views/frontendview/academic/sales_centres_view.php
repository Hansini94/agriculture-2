          ...
          <div class="container inner_page_top_heading">
            <div class="row ms-auto">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Sales Centres</b></li>
              </ol>
            </nav>
            </div>
          </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-8 col-12">                
                                ...
                                <a href="<?php 
                                    ...
                                    // $module_id = $module->id;
                                    echo base_url('sales-centres/sales-centres-detail/'. $module_id . '/' .$name);
                            ...
                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                                ...
                                <div class="row ms-auto">
                                    <?php 
                                    $unit_gallery = get_sales_images($detail->id);
                            ...
                            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
                                ...
                                <div class="row ms-auto">
                                    <?php 
                                        $unit_gallery = get_sales_images($advanced_module[0]->id);
