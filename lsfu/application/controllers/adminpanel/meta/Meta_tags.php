...
//echo "ff";exit();
    private $table_name = "tbl_livestock_meta_tags";
    private $page_id = "27";
    ...
    public function view($data = "") {
        ...
        $data['meta_list'] = $this->common_model->get_all_data_multi_where('tbl_livestock_meta_tags', $field = array(), $value = array(), 'iOrder', 'asc');
