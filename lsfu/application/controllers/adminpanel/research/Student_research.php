...
Class Student_research extends CI_Controller {
    ...
    private $table_name = "tbl_livestock_student_research";
    private $page_id = "21";
    private $redirect_path = "adminpanel/research/student_research";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/research/student_research_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/research/student_research');
            } else {
