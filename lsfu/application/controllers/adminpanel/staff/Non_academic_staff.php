...
Class Non_academic_staff extends CI_Controller {
    ...
    private $table_name = "tbl_livestock_non_academic_staff";
    private $table_name1 = "tbl_livestock_non_academic_staff_caption";
    private $table_name2 = "tbl_livestock_non_academic_staff_category";
    private $page_id = "11";
