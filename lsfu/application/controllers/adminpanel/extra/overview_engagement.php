...
Class Overview extends CI_Controller {
    ...
    private $table_name = "tbl_livestock_engagement_overview";
    private $page_id = "22";
    ...
    public function index() {	
        ...
        $this->load->view('adminpanel/engagements/overview_view', $data);
    ...
    public function save_data($data = '') {
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/engagements/overview');
            } else {
    ...
    public function remove_image() {
        if ($this->common_library->check_privilege('p_edit')) {
            ...
            if ($postimage_delete == TRUE) {
                redirect(base_url() . "adminpanel/engagements/overview/update_details/".$imageID);
            } else {
